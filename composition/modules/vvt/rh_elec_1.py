...
REM If supply air is too warm, no need for electric reheat
IF NET-SAT > 75.0 THEN GOTO 800
REM
REM --- DAT High Limit (electric only) ---
REM Safety cutoff — discharge temp too high
...
REM Damper must be at minimum heating position before stage fires
