...
def build():
    return Module(
        ...
        values=[
            ...
            ValuePoint(8,  "HIGH-RMT",        "AV", 70.4,  "Highest zone temp",                  "°F"),
            ValuePoint(9,  "AVG-RMT",         "AV", 69.1,  "Average zone temp",                  "°F"),
            ValuePoint(10, "LOW-RMT",         "AV", 68.4,  "Lowest zone temp",                   "°F"),
            ValuePoint(11, "HIGH-SP-DEV",     "AV", 0.6,   "Highest setpoint deviation",         "°F"),
            ValuePoint(12, "LOW-SP-DEV",      "AV", -2.4,  "Lowest setpoint deviation",          "°F"),
