...
Based on SBS tested VAV (1213.json) — 50 AVs, 24 BVs, 6 MVs, 4 LOOPs.
...
REM
IF FLO/DMP-CTRL-OVR = 1 THEN GOTO 100
...
IF FLO/DMP-CTRL-OVR >= 6 THEN GOTO 200
GOTO 300
REM
REM --- Auto Mode ---
100 REM Auto flow setpoint based on HVAC mode
...
GOTO 300
REM
REM --- Manual Position Modes ---
200 REM Manual damper position or full close/open
REM These bypass flow control entirely
IF FLO/DMP-CTRL-OVR = 7 THEN BV6 = 0
IF FLO/DMP-CTRL-OVR = 8 THEN BV6 = 0
GOTO 999
REM
REM --- Apply Flow Setpoint ---
300 REM Enable flow control and write setpoint
BV6 = 1
AV5 = FLO-SP
REM
999 REM End
...
REM {parent} = BACnet device of the AHU serving this VAV zone
REM Uses legacy array method: writes to parent AY1-AY8
REM BOX-# determines array index position
REM AHU-# determines which AHU (for multi-AHU systems)
REM
REM Skip if AHU not OK
IF NOT AHU-OK THEN GOTO 999
REM
REM --- Write Zone Data to Parent Arrays ---
REM AY1 = Room temps (high)
REM AY2 = Room temps (for avg calc)
REM AY3 = Room temps (low)
REM AY4 = Cooling demand
REM AY5 = Heating request
REM AY6 = Damper position (for max calc)
REM AY7 = Setpoint deviation (high)
REM AY8 = Setpoint deviation (low)
REM
{parent}AY1[ BOX-# ] = ACT-RMT
{parent}AY2[ BOX-# ] = ACT-RMT
{parent}AY3[ BOX-# ] = ACT-RMT
{parent}AY4[ BOX-# ] = CLG-DMD
{parent}AY5[ BOX-# ] = HTG-REQ
{parent}AY6[ BOX-# ] = DMP-POS
{parent}AY7[ BOX-# ] = MAX( 0.0, RMT-DEV )
{parent}AY8[ BOX-# ] = MIN( 0.0, RMT-DEV )
REM
999 REM End
"""
...
def build():
    return Module(
        ...
        values=[
            ...
            # ── Legacy array method ──
            ValuePoint(73, "BOX-#",            "AV", 1.0,   "Box Number (array index)",           ""),
            ...
            ValuePoint(71, "AHU-#",            "MV", "One",
                       "AHU Number (legacy array)",
