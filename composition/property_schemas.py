...
# ============================================================
# INSTANCE RESERVATION RULES
# ============================================================
# RC-FLEXair factory points: AV1-5, AV7 are firmware-reserved.
#   AV6 is available (gap in factory sequence).
#   User VAV values MUST start at AV8 minimum.
#   AI4, AI5, BI6, BO8, BV6, MO7 also reserved.
#
# AHU/Parent locked instances: AV16-19, AV111-119 reserved for zone data.
#   Never assign user points to these in AHU or parent controllers.
#
# MACH-ProView LCD: AI7, AI8, AI10, BI9 reserved.
# ============================================================
